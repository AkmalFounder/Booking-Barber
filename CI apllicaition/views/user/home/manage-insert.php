...
$con = connect();
	if (isset($_POST['regascus'])){
        ...
        $checkSQL = "SELECT * FROM `users_info` WHERE email = '$email';";
	        	...
	        	if (isset($_FILES['image'])) {
				 // files handle
				    ...
				    if ($extension =="jpg" || $extension =="png" || $extension =="jpeg"){
				    	...
				    	$iquery="INSERT INTO `users_info`(`users_name`, `email`, `phone`, `address`, `logo`, `password`, `role`) 
        	...
        	echo '<script>window.location="register.php"</script>';
	        	...
	        	if (isset($_FILES['image'])) {
				 // files handle
				    ...
				    if ($extension =="jpg" || $extension =="png" || $extension =="jpeg"){
				    	move_uploaded_file($file_tmp,$targetDirectory.$file_name);
				    	$iquery="INSERT INTO `users_info`(`users_name`, `email`, `phone`, `address`, `location`, `logo`, `password`, `role`) 
    ...
    if (isset($_POST['book'])) {
       ...
       if ($bdinsert == true && $iinsert == true) {
    		echo '<script>alert("Booking berhasil, silahkan cek invoice & konfirmasi pihak barber di My Booking.")</script>';
