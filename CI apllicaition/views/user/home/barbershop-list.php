        ...
        <div class="container">
          <div class="row slider-text align-items-center justify-content-center">
            <div class="col-md-10 col-sm-12 ftco-animate text-center">
              <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home</a></span> <span>Barbershop</span></p>
              <h1 class="mb-3">List Barbershop</h1>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 reservation pt-5 px-5">
            <p style="font-size: 90px; color: #5250c4;font-weight: bold;margin-top: -30px">Mulai Reservasi</p>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-5">
          <div class="col-md-7 text-center heading-section ftco-animate">
            <span class="subheading">Barbershop Kami</span>
            <h2>Temukan Barbershop Ekslusif Kami</h2>
          </div>
        </div>
            ...
            <div class="tab-content py-5" id="v-pills-tabContent">
              <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                <div class="row">
                  <?php
                  $con = connect();
                  $sql = "SELECT * FROM `users_info` WHERE location = '$area_id';";
                  $result = $con->query($sql);
                  foreach ($result as $r) {
                  ?>
                    <div class="col-lg-12">
                      <div class="menus d-flex ftco-animate">
                        ...
                        <div class="text d-flex">
                          ...
                          <div class="one-third">
                            <a href="reservation.php?res_id=<?php echo $r['id']; ?>" class="btn btn-info" style="cursor: pointer" style="width: 100%;margin-left: 23px;margin-top: 18px;">Pilih</a>
                          </div>
                        </div>
                      </div>
                    </div>
